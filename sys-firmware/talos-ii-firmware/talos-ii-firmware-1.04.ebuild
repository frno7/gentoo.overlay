...
SRC_URI="
	https://wiki.raptorcs.com/w/images/8/8f/Talos_ii_openbmc_v1.04_bundle.tar.bz2
		-> talos-ii-openbmc-v1.04-bundle.tar.bz2
	...
	verify-sig? (
		https://raptorcs.com/verification/gpg/talos_ii/firmware_builds/v1.04/talos_ii_openbmc_v1.04_bundle.tar.bz2.asc
			-> talos-ii-openbmc-v1.04-bundle.tar.bz2.asc
		https://raptorcs.com/verification/gpg/talos_ii/firmware_builds/v1.04/talos_ii_host_pnor_v1.03.bin.bz2.asc
			-> talos-ii-pnor-v1.03.bin.bz2.asc
		https://raptorcs.com/verification/gpg/talos_ii/firmware_builds/v1.04/talos-system-fpga-v1.05.rom.asc
...
pkg_postinst() {
	elog "Review:"
	elog
	elog "https://wiki.raptorcs.com/wiki/Talos_II/Firmware#System_Package_v1.04"
	elog "https://wiki.raptorcs.com/wiki/Updating_Firmware"
	elog
	elog "https://wiki.raptorcs.com/wiki/File:Talos_ii_openbmc_v1.04_bundle.tar.bz2"
