...
PATCHES=(
	"${FILESDIR}/qemu-mipsr5900el-4.2-linux-user-mips-Support-the-n32-ABI-for-the-R5900.patch"
	"${FILESDIR}/qemu-mipsr5900el-4.2-Revert-target-mips-Disable-R5900-support.patch"
)
